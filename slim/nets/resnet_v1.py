...
The 'v1' residual networks (Resslim.nets) implemented in this module were proposed
by:
...
def resnet_v1(inputs,
  ...
  block instantiations that produce Resslim.nets of various depths.

  Training for image classification on Imagenet is usually done with [224, 224]
  inputs, resulting in [7, 7] feature maps at the output of the last ResNet
  block for the Resslim.nets defined in [1] that have nominal stride equal to 32.
  ...
  (FCN) mode and global_pool needs to be set to False. The Resslim.nets in [1, 2] all
